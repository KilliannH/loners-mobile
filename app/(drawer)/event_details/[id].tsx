    ...
    return (
        ...
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <Text style={styles.meta}>
                Date : {new Date(event.date).toLocaleDateString()} à{" "}
            ...
            <View style={{ marginTop: 16 }}>
                {joined ? (
                    <TouchableOpacity style={[styles.btn, { backgroundColor: "#ef4444" }]} onPress={handleLeave}>
                        ...
                        <Text style={styles.btnText}>Quitter l’événement</Text>
                    </TouchableOpacity>
                ) : (
                    <TouchableOpacity style={[styles.btn, { backgroundColor: "#000" }]} onPress={handleJoin}>
                        <UserPlus size={18} color="#fff" />
                        <Text style={styles.btnText}>Rejoindre l’événement</Text>
                    </TouchableOpacity>
                )}
                <TouchableOpacity
                ...
                >
                    ...
                    <Text style={[styles.btnText, { color: "#000" }]}>Accéder au chat</Text>
                </TouchableOpacity>
            </View>
            ...
            >
                <Pressable style={styles.modalOverlay} onPress={() => setShowDeleteModal(false)}>
                    <View style={styles.modalContent}>
                        <Text style={{ fontWeight: "bold", fontSize: 16, marginBottom: 8 }}>Supprimer</Text>
